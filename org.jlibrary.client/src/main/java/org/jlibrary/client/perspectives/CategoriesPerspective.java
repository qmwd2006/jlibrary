...
public class CategoriesPerspective implements IPerspectiveFactory {
	
	public static final String PERSPECTIVE_ID = 
		"org.jlibrary.client.perspectives.CategoriesPerspective"; 
