 ...
 * @author martin
 *
 * Group of actions for Roles View
 */
public class RolesActionGroup extends ActionGroup implements ISelectionChangedListener {
	
	private NewRolAction fNew;
	private DeleteRolAction fRemove;
	
	private OpenAction fOpen;
	
	private ViewPart part;
	
	public RolesActionGroup(ViewPart part) {
		
		super();
		this.part = part;
		
		fNew = new NewRolAction(part.getViewSite());
		fRemove = new DeleteRolAction(part.getViewSite());
	...
	public NewRolAction getNewRolAction() {		
