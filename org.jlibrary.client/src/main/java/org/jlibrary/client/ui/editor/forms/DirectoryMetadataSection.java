...
public class DirectoryMetadataSection extends SectionPart {
	...
	public DirectoryMetadataSection(FormToolkit toolkit,
								    DirectoryFormMetadata formMetadata, 
									Composite parent) {

		super(parent, toolkit, Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED );
		
		this.formMetadata = formMetadata;
		this.directory = formMetadata.getDirectory();
	...
	protected void createClient(FormToolkit toolkit) {
		...
		data = new GridData();
		data.widthHint = 100;
		positionText = toolkit.createText(leftSection,"", SWT.WRAP | SWT.FLAT);
		...
		positionText.setText(directory.getPosition().toString());
	}
