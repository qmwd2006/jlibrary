 ...
 * @author martin
 */
public class RolGroupsSection extends SectionPart {
	...
	public RolGroupsSection(FormToolkit toolkit,
		...
		if (rol.getMembers() != null) {
			Iterator it = rol.getMembers().iterator();
			while (it.hasNext()) {
				Member member = (Member) it.next();
				if (member instanceof Group) {
					currentGroups.add(member);
				}
			}
		}
