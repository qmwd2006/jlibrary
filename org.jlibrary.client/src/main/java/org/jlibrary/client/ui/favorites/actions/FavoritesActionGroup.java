 ...
 */
public class FavoritesActionGroup extends ActionGroup implements ISelectionChangedListener {
	
	private DeleteFavoriteAction fRemove;
	
	private ViewPart part;
	
	public FavoritesActionGroup(ViewPart part) {
		
		super();
		this.part = part;
		
		fRemove = new DeleteFavoriteAction(part.getViewSite());
	}
