...
public class RolMetadataSection extends SectionPart {
	...
	public RolMetadataSection(FormToolkit toolkit,
							  RolFormMetadata formMetadata, 
							  Composite parent) {

		super(parent, toolkit, Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED );
		
		this.formMetadata = formMetadata;
		this.rol = formMetadata.getRol();
	...
	protected void createClient(FormToolkit toolkit) {
		...
		if (rol.getName().equals(Rol.ADMIN_ROLE_NAME) ||
			...
			nameText.setText(Messages.getMessage(rol.getName()));
			nameText.setEnabled(false);
			descriptionText.setText(Messages.getMessage(rol.getDescription()));
			descriptionText.setEnabled(false);
		} else {		
			nameText.setText(rol.getName());
			descriptionText.setText(rol.getDescription());
		}
	}
