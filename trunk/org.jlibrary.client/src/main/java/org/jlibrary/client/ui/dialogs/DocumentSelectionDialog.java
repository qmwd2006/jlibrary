 ...
 * @author martin
 *
 * Dialog used for selecting documents from a repository
 */
public class DocumentSelectionDialog extends Dialog {
	...
	private static DocumentSelectionDialog instance;
	 ...
	 */
	private DocumentSelectionDialog(IWorkbenchWindow window) {
	...
	protected Control createDialogArea(final Composite parent) {
		...
		viewer = new RepositoryViewer(outer,window,RepositoryViewer.DIRECTORIES_AND_DOCUMENTS);
	...
	protected void okPressed() {
		...
		documents.clear();
		document = (Document)((IStructuredSelection)viewer.getSelection()).getFirstElement();
	...
	/**
	 * Returns an unique instance of this DocumentSelectionDialog
	 * 
	 * @param window Parent window
	 * @return Unique instance of this dialog
	 */
	public static DocumentSelectionDialog getInstance() {
		
		if (instance == null) {
			instance = new DocumentSelectionDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow());
		}
	 ...
	 * 
	 * @return Document that was selected
	 */
	...
	public List getSelectedDocuments() {
