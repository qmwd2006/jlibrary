 ...
 */
public class NavigateBackwardAction extends Action implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		IAction forwardAction = HistoryTracker.getForwardAction();
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		HistoryTracker.setBackwardAction(action);
		...
		if (!HistoryTracker.hasPrevious(editor,url)) {
			return;
		}
