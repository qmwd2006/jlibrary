 ...
 * @author martin
 *
 * Group of actions for Users View
 */
public class UsersActionGroup extends ActionGroup implements ISelectionChangedListener {
	
	private NewUserAction fNew;
	private DeleteUserAction fRemove;
	private OpenAction fOpen;
	
	private ViewPart part;
	
	public UsersActionGroup(ViewPart part) {
		
		super();
		this.part = part;
		
		fNew = new NewUserAction(part.getViewSite());
		fRemove = new DeleteUserAction(part.getViewSite());
	...
	public NewUserAction getNewUserAction() {		
