...
public class CategoryMetadataSection extends SectionPart {
	...
	public CategoryMetadataSection(FormToolkit toolkit,
				CategoryFormMetadata formMetadata, 
							   Composite parent) {

		super(parent, toolkit, Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED );
		
		this.formMetadata = formMetadata;
		this.category = formMetadata.getCategory();
	...
	protected void createClient(FormToolkit toolkit)
	{
		...
		if (category.isUnknownCategory()) {
			nameText.setText(Messages.getMessage("category_unknown"));
		} else {
			nameText.setText(category.getName());
		}
		if (category.isUnknownCategory()) {
			descriptionText.setText(
					Messages.getMessage("category_unknown_description"));
		} else {
