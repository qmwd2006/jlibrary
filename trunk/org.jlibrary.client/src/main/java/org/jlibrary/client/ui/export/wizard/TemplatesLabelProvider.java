 ...
 * @author martin
 * 
 * Label provider for our templates list
 */
public class TemplatesLabelProvider implements ITableLabelProvider {
	...
	public Image getColumnImage(Object element, int arg1) {
		...
		return SharedImages.getImage(SharedImages.IMAGE_DIRECTORY);
	}
