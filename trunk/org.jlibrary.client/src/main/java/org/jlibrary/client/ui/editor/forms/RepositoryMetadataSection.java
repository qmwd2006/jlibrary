 ...
 * @author user
 *
 * Section part for repository basic information
 */
public class RepositoryMetadataSection extends SectionPart {
	...
	public RepositoryMetadataSection(FormToolkit toolkit,
