 ...
 * @author martin
 *
 * This action will be called to cut the selection and copy it to the clipboard
 */
public class CutAction extends SelectionDispatchAction {
	
	static Logger logger = LoggerFactory.getLogger(CutAction.class);
	...
	public CutAction(IWorkbenchSite site, Clipboard clipboard, SelectionDispatchAction pasteAction) {
		...
		setText(Messages.getMessage("item_cut"));
		setToolTipText(Messages.getMessage("tooltip_cut"));
		setImageDescriptor(SharedImages.getImageDescriptor(SharedImages.IMAGE_CUT));
		setDisabledImageDescriptor(SharedImages.getImageDescriptor(SharedImages.IMAGE_CUT_DISABLED));
