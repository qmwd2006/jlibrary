 ...
 * @author martin
 *
 * Filter to sort by name
 */
public class PositionFilter extends ViewerSorter {
	...
	private Comparator nameComparator = new Comparator() {
		public int compare(Object o1, Object o2) {
			...
			if (!reversed) {
				...
				return node2.getPosition().compareTo(node1.getPosition());
			}
		}
	};
	...
	public Object[] filter(Viewer viewer, Object parent, Object[] elements) {
		...
		Arrays.sort(elements, nameComparator);
		return elements;
	}
