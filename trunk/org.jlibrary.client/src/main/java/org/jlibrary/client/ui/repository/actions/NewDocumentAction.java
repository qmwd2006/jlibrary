...
import org.jlibrary.client.ui.repository.wizard.NewDocumentWizard;
 ...
 * a new document
 */
public class NewDocumentAction extends SelectionDispatchAction {
	 ...
	 * Constructor
	 */
	public NewDocumentAction(IWorkbenchSite site) {
		
		super(site);
		this.site = site;
		setText(Messages.getMessage("item_new_document"));
		setToolTipText(Messages.getMessage("tooltip_new_document"));
		setImageDescriptor(SharedImages.getImageDescriptor(SharedImages.IMAGE_NEW_DOCUMENT));
		setDisabledImageDescriptor(SharedImages.getImageDescriptor(SharedImages.IMAGE_NEW_DOCUMENT_DISABLED));
	}
	...
	public void run(Object[] elements) {
	    ...
	    NewDocumentWizard ndw = new NewDocumentWizard(parent,repository);
