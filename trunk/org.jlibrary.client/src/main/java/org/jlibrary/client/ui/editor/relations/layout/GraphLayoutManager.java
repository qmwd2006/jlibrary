...
public class GraphLayoutManager extends AbstractLayout
{
	...
	private RelationsDiagramPart schema;

	public GraphLayoutManager(RelationsDiagramPart schema)
	{
		this.schema = schema;
	}

	/**
	 * @see AbstractLayout#calculatePreferredSize(org.eclipse.draw2d.IFigure, int, int)
	 */
	...
	public void layout(IFigure container)
	{
		...
		new DirectedGraphLayoutVisitor().layoutDiagram(schema);
