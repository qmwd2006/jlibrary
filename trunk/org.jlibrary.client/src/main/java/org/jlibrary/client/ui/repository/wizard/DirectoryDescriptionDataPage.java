 ...
 */
public class DirectoryDescriptionDataPage extends WizardPage {
    ...
    public DirectoryDescriptionDataPage(String pageName, String description) {
    ...
    public void createControl(Composite outer) {
		...
		labName.setText (Messages.getMessage("new_directory_dialog_name"));
		data = new GridData ();
		...
		labDescription.setText (Messages.getMessage("new_directory_dialog_description"));
		data = new GridData ();
		data.horizontalAlignment = GridData.BEGINNING;
