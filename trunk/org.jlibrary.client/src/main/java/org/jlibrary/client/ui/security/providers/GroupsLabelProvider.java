 ...
 */
public class GroupsLabelProvider implements ITableLabelProvider {
	...
	public String getColumnText(Object element, int arg1) {
		...
		if ((name.equals("admins_group_name")) ||
			(name.equals("publishers_group_name")) ||
			(name.equals("users_group_name"))) {
