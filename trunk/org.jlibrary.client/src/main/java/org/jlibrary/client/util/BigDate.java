...
/**
  ...
  *
  * @author  copyright (c) 1997-2002 Roedy Green, Canadian Mind Products
...
public class BigDate implements Cloneable, java.io.Serializable, Comparable
   ...
   */
   ...
   java.io.IOException
   {
	...
	/**
	 * Devuelve la representación en letra de un mes determinado
	 * 
	 * @param mes Mes del que queremos obtener su representación
	 */
	public static String toStringShort(Integer mes) {
		
		return toStringShort(mes.intValue());
	}
	 ...
	 * @param mes Mes del que queremos obtener su representación
	 */
	public static String toStringShort(int mes) {
