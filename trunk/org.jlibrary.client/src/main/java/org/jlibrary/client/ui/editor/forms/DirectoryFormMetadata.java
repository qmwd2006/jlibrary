...
public class DirectoryFormMetadata {
	...
	private DirectoryMetadataFormPage formPage;
	
	private DirectoryMetadataSection metadataSection;
	
	public DirectoryFormMetadata(DirectoryMetadataFormPage formPage,
								 Directory directory,
								 Composite body) {
	...
	public DirectoryFormMetadata(Directory directory,
								 Composite body) {
	...
	protected void createFormContent(Composite body) {
		...
		labCreationDate.setText(Messages.getAndParseValue(
								...
								"%1",sdf.format(directory.getDate())));			
		
		labPath.setText(Messages.getMessage("metadata_repository_location") + directory.getPath());
	...
	private void createMetaDataSection(Composite body, Display display, FormToolkit toolkit) {
		...
		metadataSection = new DirectoryMetadataSection(toolkit,this,body);		
	}
	...
	public DirectoryMetadataSection getMetadataSection() {
