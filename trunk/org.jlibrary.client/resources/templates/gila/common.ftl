...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-EN">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${root_url}/resources/gila-screen.css" media="screen" title="Gila (screen)" />
	...
	<div id="side-bar">
		<#nested/>
		  <div class="rightSideBar">
		    <div class="sideBarText">Print <A href="${print_file}"><img src="${root_url}/resources/print.gif" border="0"/></A></div>
		  </div>		
	</div>
</#macro>
