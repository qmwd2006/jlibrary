 ...
 *
 */
public class HTTPSearchService extends HTTPStreamingServlet {

	private static final long serialVersionUID = 7520606671931567655L;
	static Logger logger = LoggerFactory.getLogger(HTTPSearchService.class);
	
	ServerProfile localProfile = new LocalServerProfile();
	private SearchService searchService;
	
	public HTTPSearchService() {
		
		searchService = JLibraryServiceFactory.getInstance(localProfile).getSearchService();
	}
