...
/**
 * This HTTP Servlet will expect calls through the GET interface to Repository Service methods. 
 * This is the basic implementation of a repository service. It doesn´t has any parsing or 
 ...
 *
 */
public class HTTPRepositoryService extends HTTPStreamingServlet {

	private static final long serialVersionUID = 7520606671931567655L;
	static Logger logger = LoggerFactory.getLogger(HTTPRepositoryService.class);
	
	ServerProfile localProfile = new LocalServerProfile();
	private RepositoryService repositoryService;
	
	public HTTPRepositoryService() {
